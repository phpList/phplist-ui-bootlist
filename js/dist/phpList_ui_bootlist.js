...
;var applyJqueryUiTabMigration = function() {
        ...
        $('[jqueryui-ajaxify-migrate="true"]').on("click", function(e) {
...
function initialiseTranslation(text) {
    ...
    $('#dialog #mymodaltrans').on("DOMSubtreeModified",function(){ $('#dialog #mymodaltrans').modal('hide'); });
}
...
$(document).ready(function(){
	...
	$('#dontsaveitem_list_categories').on("click", function(){
